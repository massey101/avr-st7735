...
int main(void) {
    ...
    st7735_draw_text(        5, 12, "ST7735 AVR Library", &TomThumb, 1, ST7735_COLOR_BLACK);
    ...
    st7735_draw_mono_bitmap(45, 25, (PGM_P) test_bw, ST7735_COLOR_WHITE, ST7735_COLOR_BLACK);
